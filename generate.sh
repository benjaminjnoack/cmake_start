...
add_library($OUTPUT_LIB OBJECT)
target_compile_options($OUTPUT_LIB PRIVATE -Wno-unused-parameter -Wno-conversion -Wno-sign-conversion -Wno-expansion-to-defined -Wno-implicit-fallthrough -Wno-overflow -Wno-undef)

target_include_directories($OUTPUT_LIB PUBLIC" > $CMAKE
...
target_sources($OUTPUT_LIB PRIVATE" >> $CMAKE
